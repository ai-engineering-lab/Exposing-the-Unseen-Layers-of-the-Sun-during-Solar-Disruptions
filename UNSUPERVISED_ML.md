# Unsupervised ML in This Project (Plain Language)

This document explains, in everyday words, how the solar slicing code (`solar_slicing.py`) uses **unsupervised machine learning** to turn solar images into separate "layer" images—and what that means.
...
For how to run the script and where the images are saved, see the main [README.md](README.md).
